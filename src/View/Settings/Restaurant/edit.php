    ...
    <div class="container restaurant-settings">
        ...
        <form action="/restaurant/settings/restaurant" method="post" class="bordered-form">
            ...
            <div class="button-group">
                <button id="updateBtn" type="submit" name="action" value="update">Update</button>
            </div>
        </form>
        ...
        <form action="/restaurant/settings/restaurant" method="post" class="bordered-form">
            ...
            <div class="button-group">
                <button id="updateBtn" type="submit" name="action" value="change-password">Update Password</button>
            </div>
        </form>
        ...
        <form action="/restaurant/settings/restaurant" method="post" class="bordered-form" id="delete-form">
            ...
            <div class="button-group">
                <button id="delete-btn" type="button">Delete Restaurant</button>
            </div>
        </form>
